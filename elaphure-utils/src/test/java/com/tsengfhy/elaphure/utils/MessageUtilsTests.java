...
class MessageUtilsTests {
    ...
    void testGetDefaultMessage() {
        Assertions.assertNotEquals(MessageUtils.getMessage(KEY, DEFAULT_MESSAGE), DEFAULT_MESSAGE);
        Assertions.assertEquals(MessageUtils.getMessage(RandomStringUtils.random(6), DEFAULT_MESSAGE), DEFAULT_MESSAGE);
    }
